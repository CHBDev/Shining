...
public class PlayButtonTemp : MonoBehaviour
{
		...
		void OnGUI ()
		{
				...
				if (GUI.Button (new Rect (Screen.width - 200, 300, 200, 50), "add 3 characters, random xp")) {
						...
						CharacterDataSet.CharacterTypes_Enum enum1 = (CharacterDataSet.CharacterTypes_Enum)int1;
						CharacterDataSet.CharacterTypes_Enum enum2 = (CharacterDataSet.CharacterTypes_Enum)int2;
						CharacterDataSet.CharacterTypes_Enum enum3 = (CharacterDataSet.CharacterTypes_Enum)int3;
